...
Plans:
- [ ] 16-01-PLAN.md — Wave 1 (TDD RED): define REQ-IDs v1.4 em REQUIREMENTS.md + stubs RED em tests/test_security.py (14) e tests/test_frontend.py (7)
- [ ] 16-02-PLAN.md — Wave 2: settings (config.py) + models SubmissionRequest/SubmissionContact (model_validator, caps apertados, honeypot) + storage Hash+SortedSet+fallback com cap por estado terminal + helpers featured:next
